...
export const PLATFORM_SECTIONS: PlatformSection[] = [
  ...
  { id: "live", label: "POPIT Live", hint: "Live profiles near you", href: "/live", keywords: ["live", "streaming", "on air", "near me", "popit live"] },
  { id: "map", label: "POP WORLD", hint: "Verified venues on city map", href: "/map", keywords: ["map", "world", "venues", "live", "nightlife", "pop world"] },
