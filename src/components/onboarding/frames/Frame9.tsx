      ...
      <div className="relative z-[1] mx-auto max-w-[520px] px-5 pb-[220px] pt-14">
        ...
        >
          ...
          <p className="font-sans text-[0.95rem] text-white/40">
            Enable what matters. You stay in control.
          </p>
        </motion.div>
        ...
        <div className="flex flex-col gap-3">
          {PERMISSIONS.map(({ id, label, title, description, Icon, accent, glow }, i) => (
            <motion.div
              ...
              className={`relative overflow-hidden rounded-[22px] border border-white/[0.08] bg-gradient-to-br ${accent} p-[1px]`}
            >
              <div className="relative rounded-[21px] bg-[#0A0A0A]/90 px-5 py-5 backdrop-blur-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="mb-1 font-sans text-[0.68rem] font-bold uppercase tracking-[0.18em] text-white/35">
                      {label}
                    </p>
